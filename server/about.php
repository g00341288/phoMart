    ...
    <div class="container">
      ...
      <div class="col-md-6">
        <section>
          ...
          <p>To install and run the application you will need to have an appropriate development environment. You will need a working HTTP server, a database, and a language interpreter for PHP at a minimum. <a href="https://www.apachefriends.org/download.html">XAMPP</a> or <a href="http://www.wampserver.com/en/download-wampserver-64bits/">WAMP</a> are suitable choices. XAMPP, much like WAMP, combines the Apache HTTP server, a MySQL database (MariaDB), and a selection of interpreters for scripts written in several languages, including PHP and Perl. XAMPP also comes bundled with phpMyAdmin a dashboard front-end to MySQL/MariaDB. The default XAMPP installation should be appropriate for this purpose. If you have not installed it already, you can find XAMPP here.</p>
          <p>You will also need to install the <a href="https://bower.io/#install-bower">bower</a> package manager to set up the project's client module dependencies. This can be installed with <a href="https://www.npmjs.com/">npm</a> the <a href="https://nodejs.org/en/">NodeJS</a> package manager. Ideally, you should have <a href="https://git-scm.com/downloads">git</a> and NodeJS installed before proceeding.
          </p>
        </section>
      </div>
